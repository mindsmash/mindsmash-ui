...
angular.module("msm.docs").run(["$templateCache", function($templateCache) {$templateCache.put("templates/editable-textarea.html","<div class=\"form-group\">\n  <label class=\"col-sm-2 control-label\">Textarea</label>\n  <div class=\"col-sm-10\">\n    <msm-spinner></msm-spinner>\n  </div>\n</div>");
$templateCache.put("pages/grid/grid.html","GRID");}]);